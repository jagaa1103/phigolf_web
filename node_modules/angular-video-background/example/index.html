...
<html>
  ...
  <body ng-controller="mainCtrl">
    ...
    <div class="video-container">
      ...
      <video-background class="bg-video" autoplay="false" key-controls="true" autopause="true"
        on-firstplay="isStarted = true" on-firstend="isStarted = false; isEnded = true"
        source="myVideo">
      </video-background>
    ...
    <article role="main" class="center-block">
      ...
      <header>
        <div class="hcont">
          ...
          <p>
            You can show any video you want inside your page and have fun with keyboard controls!
            <br>Press <b>space</b> to start the video.
          </p>
          <a ng-cloak href="https://github.com/codekraft-studio/angular-video-background/archive/master.zip" class="btn">Get it</a>
          <a ng-cloak href="https://github.com/codekraft-studio/angular-video-background/blob/master/README.md" class="btn">Docs</a>
        </div>
      </header>
    </article>
